...
Sections 6–7 cover the supporting detail: durable upload and cache-aware resume scheduling.
...
status:
  ...
  layers:
    memory:  {present: true, tier: local,   key: {image: sha256:…, runtime: gvisor/…, cpu: gen6}}
    rootfs:  {present: true, tier: durable, key: {image: sha256:…}}
    volumes: {present: true, tier: durable}
```
